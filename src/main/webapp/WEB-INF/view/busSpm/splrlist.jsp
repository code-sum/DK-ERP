...
<script type="text/javascript">
	...
	$(function() {
		...
		/* 모달 내부 콤보박스 모음 */
		// 은행코드 콤보
		comcombo("bk_cd","bkcombo","all","");   // group_code, combo_name, type(기본값  all : 전체   sel : 선택), selvalue(선택되어 나올 값)
	});
	...
	function fn_selectone(no) {
		    ...
		    // 주소로 좌표 검색
		    geocoder.addressSearch($("#splr_add").val(), function(result, status) {
